...
interface TimelineProps {
  sim: Pick<Simulation, 'getStatus' | 'getSpeed' | 'getMessages' | 'getCurrentIndex' | 'play' | 'pause' | 'stepForward' | 'stepBackward' | 'setSpeed' | 'jumpTo'>
}
      ...
      <div className="flex items-center gap-0.5 overflow-x-auto py-1">
        {messages.map((msg, i) => (
          <button
            ...
            style={{ backgroundColor: phaseColors[msg.phase as Phase] }}
